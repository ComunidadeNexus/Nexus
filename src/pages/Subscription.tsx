                    ...
                    <CardFooter>
                      {isCurrentPlan ? (
                        ...
                        <Button
                          ...
                          disabled={isSubscribing || plan.id === "free" || (subscribed && tier !== "free")}
                        >
                          {isSubscribing ? (
                            <>
          ...
          <div className="mt-16 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-3xl mx-auto">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Sim! Você pode cancelar sua assinatura quando quiser pelo Portal do Cliente. 
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Ao fazer upgrade, você paga apenas a diferença proporcional. 
                  No downgrade, o valor é creditado para os próximos meses.
                </p>
              </div>
              <div>
                <h3 className="font-semibold mb-2">Quais formas de pagamento são aceitas?</h3>
                <p className="text-sm text-muted-foreground">
                  Aceitamos cartões de crédito (Visa, Mastercard, Amex) e boleto bancário 
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Sim! Os Nexus Coins que você recebe mensalmente são acumulados 
                  na sua carteira e não expiram enquanto você for assinante.
                </p>
              </div>
            </div>
          </div>
