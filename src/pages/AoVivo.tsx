...
const AoVivo = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-6 pb-20 animate-fade-in">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-6 items-stretch">
          {/* Player de Vídeo */}
          <div className="flex-1 bg-black rounded-2xl overflow-hidden shadow-2xl border border-gray-800 relative aspect-video min-h-[300px] flex items-center justify-center">
            {!activeStreamerData ? (
          ...
          {showChat && (
            <div className="w-full lg:w-[350px] bg-[#18181B] rounded-2xl overflow-hidden shadow-2xl border border-gray-800 shrink-0 h-[400px] lg:h-auto flex items-center justify-center">
              {!activeStreamerData ? (
          ...
          <div className="bg-white dark:bg-[#1A282D] rounded-2xl p-5 border border-gray-200 dark:border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <img
                ...
                className={`w-16 h-16 rounded-full border-2 ${activeStreamerData.live ? "border-red-500 shadow-lg" : "border-gray-500 grayscale"}`}
              />
              <div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <button
                ...
                className="flex-1 md:flex-none px-4 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 md:flex-none px-6 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-colors shadow-lg shadow-purple-500/20"
              >
